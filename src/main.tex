...
% ---------- Skills ----------
\section*{Skills}
Go, React, TypeScript, PostgreSQL, AWS, Java, Node.js, Python (basic), REST APIs, GraphQL (basic), Docker, CI/CD, Testing (mocks/coverage), Microservices, Observability \& Logging.
